		...
		<ul>
			...
			<li>
				<form id="byConsumes" class="readJsonForm" action="<c:url value="/mapping/consumes" />" method="post">
					<input id="byConsumesSubmit" type="submit" value="javaBean어노테이션을 통한 매핑" />
				</form>
			</li>
			<li>
				<a id="byProducesAcceptJson" class="writeJsonLink" href="<c:url value="/mapping/produces" />">produces 속성 이용하여 Accept=application/json 형식 매핑</a>
			</li>
            <li>
                <a id="byProducesAcceptXml" class="writeXmlLink" href="<c:url value="/mapping/produces" />">produces 속성 이용하여 Accept=appilcation/xml 형식 매핑</a>
            </li>
            <li>
              <a id="byProducesJsonExt" class="writeJsonLink" href="<c:url value="/mapping/produces.json" />">url에 ".json" 이용하여 파일 형식 자동 매핑</a>
            </li>
            <li>
                <a id="byProducesXmlExt" class="writeXmlLink" href="<c:url value="/mapping/produces.xml" />">url에 ".xml" 이용하여 파일 형식 자동 매핑</a>
            </li>
		</ul>
	</div>
	<div id="data">
